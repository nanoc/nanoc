...
* The compile command now takes --no-assets and --no-pages options
* Dependencies between pages are now tracked properly
...
* Removed support for drafts
* Removed support for binary assets
* Removed support for templates
* Removed everything that was deprecated in nanoc 2.x
