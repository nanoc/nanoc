...
module Nanoc
  module Base
    class CompilationItemView < ::Nanoc::Base::BasicItemView
      ...
      #
      # @return [Nanoc::Base::BasicItemRepCollectionView]
      def reps
        Nanoc::Base::CompilationItemRepCollectionView.new(@context.reps[_unwrap], @context)
      end
    end
  end
end
