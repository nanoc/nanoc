  ...
  module Int
    ...
    module OutdatednessReasons
      ...
      class Generic
        ...
        # @return [Nanoc::Core::Props]
        attr_reader :props

        # @param [String] message The descriptive message for this outdatedness
        #   reason
        def initialize(message, props = Nanoc::Core::Props.new)
          @message = message
          @props = props
        end
      end
      ...
      CodeSnippetsModified = Generic.new(
        ...
        Nanoc::Core::Props.new(raw_content: true, attributes: true, compiled_content: true, path: true),
      )
      ...
      RulesModified = Generic.new(
        ...
        Nanoc::Core::Props.new(compiled_content: true, path: true),
      )

      ContentModified = Generic.new(
        'The content of this item has been modified since the last time the site was compiled.',
        Nanoc::Core::Props.new(raw_content: true, compiled_content: true),
      )
      ...
      class DocumentCollectionExtended < Generic
        ...
        def initialize(objects)
          super(
            ...
            Nanoc::Core::Props.new(raw_content: true),
          )
      ...
      class AttributesModified < Generic
        ...
        def initialize(attributes)
          super(
            ...
            Nanoc::Core::Props.new(attributes: true, compiled_content: true),
          )
      ...
      UsesAlwaysOutdatedFilter = Generic.new(
        ...
        Nanoc::Core::Props.new(raw_content: true, attributes: true, compiled_content: true),
      )
    end
  end
end
