module Nanoc3::CLI::Commands
  ...
  class Autocompile < Cri::Command # :nodoc:
    ...
    def long_desc
      handler_names = Nanoc3::Extra::AutoCompiler::HANDLER_NAMES.join(', ')
      ...
      ' (default is ' + Nanoc3::Extra::AutoCompiler::HANDLER_NAMES[0].to_s + ').'
    end
    ...
    def run(options, arguments)
      ...
      rescue Nanoc3::Extra::AutoCompiler::UnknownHandlerError
