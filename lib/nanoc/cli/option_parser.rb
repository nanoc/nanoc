module Nanoc
  ...
  module OptionParser
    ...
    class IllegalOptionError < RuntimeError
    ...
    class OptionRequiresAnArgumentError < RuntimeError
      ...
      def self.parse(arguments_and_options, definitions, ignore_illegal_options=false)
        ...
        loop do
          ...
          # Handle incomplete options
            ...
            raise IllegalOptionError.new(option_key) if definition.nil? and !ignore_illegal_options
